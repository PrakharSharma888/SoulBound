...
app.post('/issue', async(req, res) => {
    ...
    const interaction = await contract.issueDegree(req.body.address, {gasLimit : 300000})
    const done = await contract.issuedDegrees(req.body.address)

    console.log("Body : ", req.body.address)
    if(done){        
        res.send("Degree has been issued")
    }
    else{
        res.send("Failed to issue degree to you");
    }
  }); 
...
// 0xd85988bA576f12BAF3108561F5abC7301d43F74b